...
public abstract class BaseDAO<T> {
    ...
    public BaseDAO() {
        ...
        try {
            ...
            throw new DAOException("BasicDAO init exception");
    ...
    protected int executeUpdate(String sql, Object... params) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new DAOException("BaseDAO executeUpdate Exception");
        }
    }
    ...
    private void setValue(Object obj, String property, Object propertyValue) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new DAOException("Set value exception");
        }
    }
    ...
    protected Object[] executeComplexQuery(String sql, Object... params) {
        try {
            ...
            e.printStackTrace();
            throw new DAOException("BaseDAO executeComplexQuery Exception");
        }
        return null;
    }
    ...
    protected T load(String sql, Object... params) {
        try {
            ...
            e.printStackTrace();
            throw new DAOException("BaseDAO load Exception");
        }
        return null;
    }
    ...
    protected List<T> executeQuery(String sql, Object... params) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new DAOException("BaseDAO executeQuery exception");
        }
        return list;
    }
}
